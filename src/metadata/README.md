 ...
 * [mhpo.yml](mhpo.yml)
     * Determines how your purl.obolibrary.org/obo/mhpo/ redirects will be handled
     ...
     * Paste in the contents of [mhpo.yml](mhpo.yml)
 ...
 * [mhpo.md](mhpo.md)
     ...
     * Paste in the contents of [mhpo.md](mhpo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
